...
const slides = [
	{
		url:
			"https://images.unsplash.com/photo-1627587780063-1655815c958b?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTYzNTIzNzA2MA&ixlib=rb-1.2.1&q=85",
		heading: "Great Food",
		tagline: "Enjoy our famed selection of World Class Meals"
	},
	{
		url:
			"https://images.unsplash.com/photo-1633119368937-9993a58cdaaa?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTYzNTIzNzA2MA&ixlib=rb-1.2.1&q=85",
		heading: "The Best Drinks",
		tagline: "Cool off with our exotic drinks"
	},
	{
		url:
			"https://images.unsplash.com/photo-1634370058578-41e7092f261f?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTYzNTIzNzA2MA&ixlib=rb-1.2.1&q=85",
		heading: "Plenty of Adventure",
		tagline: "Go on hikes in the beautiful landscapes overlooking the resort"
	},
	{
		url:
			"https://images.unsplash.com/photo-1634048766558-916c82e0ba91?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTYzNTIzNzA2MA&ixlib=rb-1.2.1&q=85",
		heading: "Vibrant Nightlife",
		tagline:
			"It's a ten minute drive to the city, with a variety of activities for a fun night out on the town"
	},
	{
		url:
			"https://images.unsplash.com/photo-1633596667725-e3f715436023?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTYzNTIzNzA2MA&ixlib=rb-1.2.1&q=85",
		heading: "Get in the Zone",
		tagline:
			"Whether it's work, study, or a retreat, our serene environment will provide all the zen you need"
	},
	{
		url:
			"https://images.unsplash.com/photo-1633885278462-f6e52e3081fb?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTYzNTIzNzA2MA&ixlib=rb-1.2.1&q=85",
		heading: "Recharge your batteries",
		tagline:
			"When you need a getaway from all the hustle, or just need to enjoy nature, we'll be right here"
	}
];
...
function createStyles() {
	...
	.slideHeading {
		font-family: ${options.heading_font};
		font-size: ${options.heading_size};
		color: ${options.heading_color};
	}
	.slideTagline {
		font-family: ${options.tagline_font};
